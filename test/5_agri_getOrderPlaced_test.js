const AgriContractGetOrderPlaced = artifacts.require("./agriFoodSupplyChain.sol");

contract("AgriContractGetOrderPlaced", (accounts) => {
    ...
    it("...test must success for getOrderPlaced() by seller", async () => {
        ...
        assert.equal(sellerOrderPlacedDetails[3], "", "product shipment details is not same as expected");
