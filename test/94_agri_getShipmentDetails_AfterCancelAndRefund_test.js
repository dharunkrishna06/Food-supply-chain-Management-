const AgriContractGetShipmentDetailsAfterCancelAndRefund = artifacts.require("./agriFoodSupplyChain.sol");

contract("AgriContractGetShipmentDetailsAfterCancelAndRefund", (accounts) => {
    ...
    it("...test must success for getShipmentDetails()", async () => {
        ...
        assert.equal(sellerShipmentDetailsDetails[1], "Order Canceled By Buyer, Payment Refunded", "product shipment details is not same as expected");
