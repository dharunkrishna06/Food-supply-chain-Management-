const AgriContractGetOrderPlacedAfterCancelAndRefund = artifacts.require("./agriFoodSupplyChain.sol");

contract("AgriContractGetOrderPlacedAfterCancelAndRefund", (accounts) => {
    ...
    it("...test must success for getOrderPlaced() by seller", async () => {
        ...
        assert.equal(sellerOrderPlacedDetails[3], "Order Canceled By Buyer, Payment Refunded", "product shipment details is not same as expected");
    ...
    it("...test must returns error for getOrderPlaced() when buyer access it instead of seller", async () => {
        ...
        try{
            ...
            await afsc.refundToBuyer("test productId_4", 4, {from: seller1, value:6000000000000000000})
